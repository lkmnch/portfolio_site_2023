...
const Hero = () => {
	...
	return (
		<section className='bg-orange-100'>
			<div
				className='container mx-auto flex flex-wrap justify-center text-center items-center lg:text-left lg:justify-start lg:flex-nowrap h-max gap-5 p-10 '
				id='HERO-CONTAINER'>
				<div id='img+socials' className='flex flex-col gap-5  items-center'>
					<img
						src={imgUrl}
						alt='about-placeholder'
						className='rounded-full border-4 border-stone-900 shadow-lg w-44 lg:w-80'
					/>
